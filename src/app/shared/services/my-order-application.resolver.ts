...
import { MyOrderApplicationService } from './my-order-application.service';

@Injectable({ providedIn: 'root' })
export class MyOrderApplicationResolver
  implements Resolve<GridModel<SearchApplicationResponse>>
{
   ...
   * @param $data
   */
  constructor(private $data: MyOrderApplicationService) {}
